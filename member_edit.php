            ...
            <tr height="40">
                ...
                <td align="left">
                    <div class="d-inline-flex">
                        <input type="password" name="pwd" size="20" value="" class="form-control form-control-sm">
                    </div>
                    <br>&nbsp; ※ 비밀번호 변경할 때만 입력.
                </td>
            </tr>
            <tr height="40">
                ...
                <td align="left">
                    <div class="d-inline-flex my-1">
                        <input type="password" name="pwd1" size="20" value="" class="form-control form-control-sm">
                    </div>
                </td>
            </tr>
            <tr height="40">
            ...
            <tr height="40">
                ...
                <td align="left">
                    <div class="d-inline-flex mt-2">
                        <input type="text" name="birthday1" size="4" value="<?= $birthday1; ?>" class="form-control form-control-sm"> -
                        <input type="text" name="birthday2" size="2" value="<?= $birthday2; ?>" class="form-control form-control-sm"> -
                        <input type="text" name="birthday3" size="2" value="<?= $birthday3; ?>" class="form-control form-control-sm">
                    </div>
                </td>
            </tr>
        </table>
