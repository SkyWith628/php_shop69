...
function FindZip(zip_kind) {
    window.open("zipcode.php?zip_kind=" + zip_kind, "zip", "width=440,height=320,scrollbars=no");
}
...
function check_id() {
    ...
    window.open("member_idcheck.php?uid=" + form2.uid.value, "", "width=300,height=200,scrollbar=no");
}
...
<div class="row m-1 mb-0">
    <div class="col text-center">
        <h4 class="mt-5">회원 가입</h4>
        <hr class="my-3" style="height:4px;">
        ...
        <table style="font-size:12px;">
            <tr height="40">
                ...
                <td align="left">
                    <div class="d-inline-flex">
                        <input type="text" name="uid" size="20" class="form-control form-control-sm">
                    </div>
            ...
            <tr height="40">
                ...
                <td align="left">
                    <input type="password" name="pwd" size="20" pattern="^([a-z0-9_]){6,50}$" placeholder="영문자,숫자,밑줄만 이용" class="form-control form-control-sm">
                </td>
            </tr>
            <tr height="40">
                <td align="left">비밀번호 확인 <font color="red">*</font></td>
                <td align="left">
                    <input type="password" name="pwd1" size="20" pattern="^([a-z0-9_]){6,50}$" placeholder="영문자,숫자,밑줄만 이용" class="form-control form-control-sm mb-2">
                </td>
            </tr>
            <tr height="40">
            ...
            <tr height="90">
                ...
                <td align="left">
                    <div class="d-inline-flex mb-1">
                        <input type="text" name="zip" id="zip11" size="5" maxlength="5" class="form-control form-control-sm">&nbsp;
                    </div>
                    <a href="javascript:FindZip(0);" class="btn btn-sm btn-secondary text-white mb-1" style="font-size:12px">우편번호 찾기</a><br>
                    <input type="text" name="juso" id="juso11" size="50" class="form-control form-control-sm">
                </td>
            </tr>
            <tr height="40">
                <td align="left">E-Mail</td>
                <td align="left">
                    <input type="text" name="email" size="50" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" class="form-control form-control-sm">
                </td>
            </tr>
            <tr height="40">
                <td align="left">생일</td>
                <td align="left">
                    <div class="d-inline-flex mt-2">
                        <input type="text" name="birthday1" size="4" maxlength="4" class="form-control form-control-sm"> -
                        <input type="text" name="birthday2" size="2" maxlength="2" class="form-control form-control-sm"> -
                        <input type="text" name="birthday3" size="2" maxlength="2" class="form-control form-control-sm">
                    </div>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <div class="d-inline-flex">
